	...
	Ext.define('Mba.ux.Field.SignatureField', {
...
initialize: function(){
	...
	this.returnButton = Ext.create('Ext.Button', {
	       //text:'Save',
	       ui:'plain',
	       iconCls:'voltar'
	   });
	...
	this.actionOverlay = Ext.create('Ext.Panel', {
       ...
       items:[this.actionOverlayCanvas,
       {
           xtype:'toolbar',
           docked:'bottom',
           items:[{xtype: 'spacer'},this.returnButton,this.resetButton,this.saveButton,{xtype: 'spacer'}]
       }]
   });
	...
	this.returnButton.element.on('tap', this.hideCanvas, this);
